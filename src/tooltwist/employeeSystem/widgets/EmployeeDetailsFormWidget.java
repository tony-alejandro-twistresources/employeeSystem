...
/**
 * Employee Details Editable Form
 */
public class EmployeeDetailsFormWidget extends WbdWidgetController {
	private static final String SNIPPET_PREVIEW = "employeeDetailsForm_preview.html";
	private static final String SNIPPET_DESIGN = "employeeDetailsForm_design.html";
	private static final String SNIPPET_PRODUCTION = "employeeDetailsForm_production.jsp";
	...
	public void getCodeInserters(WbdGenerator generator, WbdWidget instance, UimData ud, CodeInserterList codeInserterList) throws WbdException {
		...
		if (mode == GenerationMode.DESIGN) {
			...
			new StylesheetCodeInserter(generator, instance, "employeeDetailsForm_cssHeader.css"), };
			...
			if (USE_PRODUCTION_HELPER) {
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, EmployeeDetailsFormProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(EmployeeDetailsFormProductionHelper.class.getName()));
			}
		}
