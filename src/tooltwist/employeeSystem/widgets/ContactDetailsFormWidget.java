...
import tooltwist.employeeSystem.productionHelpers.ContactDetailsFormProductionHelper;
import com.dinaa.ui.UimData;
import com.dinaa.ui.UimHelper;

/**
 * Contact Details Form Widget
 */
public class ContactDetailsFormWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "contactDetailsForm_preview.html";
	private static final String SNIPPET_DESIGN = "contactDetailsForm_design.html";
	private static final String SNIPPET_PRODUCTION = "contactDetailsForm_production.jsp";
...
//TODO: Uncomment this as required
		...
		if (mode == GenerationMode.DESIGN)
		{
			...
			CodeInserter[] arr = {
				...
				new StylesheetCodeInserter(generator, instance, "contactDetailsForm_cssHeader.css"),
			};
...
//				new StylesheetLinkInserter(cssUrl),
				...
				new JavascriptCodeInserter(generator, instance, "contactDetailsForm_jsHeader.js"),
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, ContactDetailsFormProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(ContactDetailsFormProductionHelper.class.getName()));
			}
		}
