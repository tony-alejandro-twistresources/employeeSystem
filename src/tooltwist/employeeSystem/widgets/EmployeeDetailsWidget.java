...
import tooltwist.employeeSystem.productionHelpers.EmployeeDetailsProductionHelper;
...
public class EmployeeDetailsWidget extends WbdWidgetController
{
	...
	protected void init(WbdWidget instance) throws WbdException
	{
		...
		instance.defineProperty(new WbdNavPointProperty("homePage", null, "Home Page", ""));
	}
...
//					new JavascriptLinkInserter("/ttsvr/js/jquery-1.10.2.min.js", CodeInsertionPosition.BOTTOM) 
	...
	private SnippetParam[] getSnippetParams(WbdGenerator generator, WbdWidget instance, UimData ud) throws WbdException {
		...
		String homePage = instance.getProperty("homePage", null);
		SnippetParam[] params = {
			new SnippetParam("target", target),
			new SnippetParam("homePage", homePage)
		};
		return params;
	}
}
