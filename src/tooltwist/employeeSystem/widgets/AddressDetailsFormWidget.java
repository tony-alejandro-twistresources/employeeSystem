...
import tooltwist.employeeSystem.productionHelpers.AddressDetailsFormProductionHelper;
import com.dinaa.ui.UimData;
import com.dinaa.ui.UimHelper;

/**
 * Address Details Editable Form
 */
public class AddressDetailsFormWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "addressDetailsForm_preview.html";
	private static final String SNIPPET_DESIGN = "addressDetailsForm_design.html";
	private static final String SNIPPET_PRODUCTION = "addressDetailsForm_production.jsp";
...
//TODO: Uncomment this as required
		...
		if (mode == GenerationMode.DESIGN)
		{
			...
			CodeInserter[] arr = {
				...
				new StylesheetCodeInserter(generator, instance, "addressDetailsForm_cssHeader.css"),
			};
...
//				new StylesheetLinkInserter(cssUrl),
				...
				new JavascriptCodeInserter(generator, instance, "addressDetailsForm_jsHeader.js"),
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, AddressDetailsFormProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(AddressDetailsFormProductionHelper.class.getName()));
			}
		}
